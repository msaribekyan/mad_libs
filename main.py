...
if story == "1":
    ...
    time = input_str("Input a measure of time: ")
    transport = input_str("Input a mode of transportation: ")
    adjective = input_str("Input an adjective: ")
    adjective2 = input_str("Input an adjective: ")
    noun = input_str("Input a noun: ")
    color = input_str("Input a color: ")
    part = input_str("Input a part of body: ")
    verb = input_str("Input a verb: ")
    number2 = input_num("Input a number: ")
    noun2 = input_str("Input a noun: ")
    noun3 = input_str("Input a noun: ")
    part2 = input_str("Input a part of body: ")
    verb2 = input_str("Input a verb: ")
    noun4 = input_str("Input a noun: ")
    adjective3 = input_str("Input an adjective: ")
    silly = input_str("Input a silly word: ")
    noun5 = input_str("Input a noun: ")
    ...
    name = input_str("Input a person's name: ")
    noun = input_str("Input a noun: ")
    feeling = input_str("Input a feeling: ")
    verb = input_str("Input a verb: ")
    feeling2 = input_str("Input a feeling: ")
    animal = input_str("Input an animal: ")
    verb2 = input_str("Input a verb: ")
    color = input_str("Input a color: ")
    verbing = input_str("Input a verb (ending in ing): ")
    adverb = input_str("Input an adverb (ending in ly): ")
    number = input_num("Input a number: ")
    time = input_str("Input a measure of time: ")
    color2 = input_str("Input a color: ")
    animal2 = input_str("Input an animal: ")
    number2 = input_num("Input a number: ")
    silly = input_str("Input a silly word: ")
    noun2 = input_str("Input a noun: ")
    ...
    adjective = input_str("Input an adjective: ")
    color = input_str("Input a color: ")
    animal = input_str("Input a animal: ")
    place = input_str("Input a place: ")
    adjective2 = input_str("Input an adjective: ")
    creature = input_str("Input a magical creature (plural): ")
    adjective3 = input_str("Input an adjective: ")
    creature2 = input_str("Input a magical creature (plural): ")
    room = input_str("Input a room in a house: ")
    noun = input_str("Input a noun: ")
    noun2 = input_str("Input a noun: ")
    noun3 = input_str("Input a noun (plural): ")
    adjective4 = input_str("Input an adjective: ")
    noun4 = input_str("Input a noun (plural): ")
    number = input_num("Input a number: ")
    time = input_str("Input a measure of time: ")
    verb = input_str("Input a verb (ending in ing): ")
    adjective5 = input_str("Input an adjective: ")
    noun5 = input_str("Input a noun: ")
